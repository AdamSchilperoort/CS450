...
#define N 10//max 2500 (for time)// try N=10, 100, 1000, 2000
...
__global__ void matrixmulti(double *A, double *B, double *C);
...
////////////////////////////	
	...
	*debug=0;
	...
	//execute kernel
	matrixmulti<<<totalBlocks,1024>>>(dev_A, dev_B, dev_C);
